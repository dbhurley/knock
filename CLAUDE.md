...
│   ├── status.html             # Client search-status surface (PWA-installable; click-to-copy ref pill, live "Updated X ago" heartbeat, full-journey overview, Google + .ics calendar links)
